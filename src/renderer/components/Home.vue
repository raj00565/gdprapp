<template>
    <div class="card" id="homepage">
        ...
        <section style="flex:1; overflow-y: scroll; overflow-x: hidden; margin-bottom: 32px;">
<div class="legal">
          <p>Legal Notices<br/>
...
<br/>
User Discussion Lists and Forums<br/>
...
<br/>
Use of Personally Identifiable Information<br/>
...
In the event you believe that material or content published on the Website may infringe on your copyright or that of another, please contact us.
        ...
        <div style="width: 100%; text-align: center">
          <router-link class="btn" :to="{ name: 'Upload'}">Accept</router-link>
        </div>
    </div>
</template>
<script>
